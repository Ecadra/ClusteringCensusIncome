...
df = df.drop(columns=['MARSUPWRT'], errors='ignore')  # 'errors=ignore' evita error si alguna no existe
...
df.to_csv('./Data/CSVs/census_income_first_classification.csv', index=False)
print("Archivo transformado guardado como 'census_income_first_classification.csv'")
